...
class GraphicsWrapper {
    ...
    // or 1-finger camera control
    public void panBasedOnDisplacementOfOnePoint( Point2D last, Point2D current ) {
        // This is the translation that the world should appear to undergo.
        Vector2D translation = Point2D.diff( current, last );
    ...
    public void panAndZoomBasedOnDisplacementOfTwoPoints(Point2D A_old, Point2D B_old,
    ...
    public void drawPolyline( ArrayList< Point2D > points, boolean isClosed, boolean isFilled ) {
        ...
        // TODO FIXME XXX or should path.setFillType() ?
